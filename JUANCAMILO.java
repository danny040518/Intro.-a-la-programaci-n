...
public class JUANCAMILO { 
	...
	static String[] Equipos = {"FRANCIA   ",
			...
			"PORTUGAL  ",
	"INGLATERRA"};
	static String alineacionf [][]=new String [8][8];
	static String alineacionb [][]=new String [8][8];
	static String alineacionale [][]=new String [8][8];
	static String alineacionargen [][]=new String [8][8];
	static String alineacionp [][]=new String [8][8];
	static String alineacioni [][]=new String [8][8];
	...
	public static void  menu() {
		...
		fut=Integer.parseInt(JOptionPane.showInputDialog("          MENU PRINCIPAL:"
				...
				+ "\n          *Ver sus jugadores y sus posiciones"
				+ "\n          *Cambiar de posición un jugador"
	...
	public static void  fran (String francia[], String suplefran []){	
		...
		int vectorPos = 0;
		for (int i = 0; i < alineacionf.length; i++) {
			for (int j = 0; j < alineacionf[i].length; j++) {
				if(vectorPos < francia.length)
					alineacionf[3][0]=francia[0]+" POR";
				alineacionf[2][2]=francia[1]+" DF";
				alineacionf[4][2]=francia[2]+" DF";
				alineacionf[5][3]=francia[3]+" LA";
				alineacionf[1][3]=francia[4]+" LI";
				alineacionf[2][3]=francia[5]+" MCD";
				alineacionf[4][4]=francia[6]+" MI";
				alineacionf[5][5]=francia[7]+" MD";
				alineacionf[1][5]=francia[8]+" EI";
				alineacionf[2][4]=francia[9]+" DC";
				alineacionf[4][5]=francia[10]+" ED";
			}
		}
		for (int i = 0; i < alineacionf.length; i++) {
			for (int j = 0; j < alineacionf[i].length; j++) {
				if(alineacionf[i][j]==null) {
					System.out.print("   ");
				}
				else {
					System.out.print(alineacionf[i][j] + " ");
	...
	public static void bras(String brasil[], String suplebra []) {
		...
		System.out.println("Equipo Predeterminado\n");
		int vectorPos = 0;
		for (int i = 0; i < alineacionb.length; i++) {
			for (int j = 0; j < alineacionb[i].length; j++) {
				if(vectorPos < brasil.length)
					alineacionb[3][0]=brasil[0]+" POR";
				alineacionb[1][2]=brasil[1]+" LI";
				alineacionb[2][1]=brasil[2]+" DF";
				alineacionb[4][1]=brasil[3]+" DF";
				alineacionb[5][2]=brasil[4]+" LA";
				alineacionb[3][1]=brasil[5]+" MCD";
				alineacionb[2][4]=brasil[6]+" MI";
				alineacionb[4][4]=brasil[7]+" MD";
				alineacionb[0][7]=brasil[8]+" EI";
				alineacionb[3][2]=brasil[9]+" DC";
				alineacionb[6][7]=brasil[10]+" ED";
			}
		}
		for (int i = 0; i < alineacionb.length; i++) {
			for (int j = 0; j < alineacionb[i].length; j++) {
				if(alineacionb[i][j]==null) {
					System.out.print("   ");
				}

				else {	System.out.print(alineacionb[i][j] + " ");
				}
			}
			System.out.println();
		}		
	...
	public static void alem (String alemania[],  String suplealem[]) {
		...
		System.out.println("Equipo Predeterminado\n");
		int vectorPos = 0;
		for (int i = 0; i < alineacionale.length; i++) {
			for (int j = 0; j < alineacionale[i].length; j++) {
				if(vectorPos < alemania.length)
					alineacionale[3][0]=alemania[0]+" POR";
				alineacionale[6][3]=alemania[1]+" LD";
				alineacionale[2][3]=alemania[2]+" DF";
				alineacionale[4][2]=alemania[3]+" DF";
				alineacionale[0][3]=alemania[4]+" LI";
				alineacionale[5][5]=alemania[5]+" MD";
				alineacionale[1][5]=alemania[6]+" MI";
				alineacionale[0][6]=alemania[7]+" EI";
				alineacionale[3][3]=alemania[8]+" MCO";
				alineacionale[6][6]=alemania[9]+" ED";
				alineacionale[3][4]=alemania[10]+" DC";
			}
		}
		for (int i = 0; i < alineacionale.length; i++) {
			for (int j = 0; j < alineacionale[i].length; j++) {
				if(alineacionale[i][j]==null) {
					System.out.print("   ");
				}

				else {	System.out.print(alineacionale[i][j] + " ");
				}
			}
			System.out.println();
		}		
	...
	public static void argent(String argentina[], String supleargen []) {
		...
		System.out.println("Equipo Predeterminado\n");
		int vectorPos = 0;
		for (int i = 0; i < alineacionargen.length; i++) {
			for (int j = 0; j < alineacionargen[i].length; j++) {
				if(vectorPos < argentina.length)
					alineacionargen[3][0]=argentina[0]+" POR";
				alineacionargen[6][3]=argentina[1]+"  LD";
				alineacionargen[2][3]=argentina[2]+"  DF";
				alineacionargen[4][3]=argentina[3]+"  DF";
				alineacionargen[0][3]=argentina[4]+"  LI";
				alineacionargen[1][6]=argentina[5]+"  MI";
				alineacionargen[3][2]=argentina[6]+"  MCD";
				alineacionargen[5][6]=argentina[7]+"  MD";
				alineacionargen[5][7]=argentina[8]+"  ED";
				alineacionargen[3][3]=argentina[9]+"  DC";
				alineacionargen[1][7]=argentina[10]+"  EI";
			}
		}
		for (int i = 0; i < alineacionargen.length; i++) {
			for (int j = 0; j < alineacionargen[i].length; j++) {
				if(alineacionargen[i][j]==null) {
					System.out.print("   ");
				}

				else {	System.out.print(alineacionargen[i][j] + " ");
				}
			}
			System.out.println();
		}	
	...
	public static void port(String portugal[], String supleportu []) {
		...
		System.out.println("Equipo Predeterminado\n");
		int vectorPos = 0;
		for (int i = 0; i < alineacionp.length; i++) {
			for (int j = 0; j < alineacionp[i].length; j++) {
				if(vectorPos < portugal.length)
					alineacionp[3][0]=portugal[0]+" POR";
				alineacionp[6][4]=portugal[1]+"  LD";
				alineacionp[2][3]=portugal[2]+" DF";
				alineacionp[4][3]=portugal[3]+" DF";
				alineacionp[0][4]=portugal[4]+" LI";
				alineacionp[1][6]=portugal[5]+" MI";
				alineacionp[3][1]=portugal[6]+" MCD";
				alineacionp[5][6]=portugal[7]+" MD";
				alineacionp[5][7]=portugal[8]+" ED";
				alineacionp[3][2]=portugal[9]+" DC";
				alineacionp[1][7]=portugal[10]+" EI";
			}
		}
		for (int i = 0; i < alineacionp.length; i++) {
			for (int j = 0; j < alineacionp[i].length; j++) {
				if(alineacionp[i][j]==null) {
					System.out.print("   ");
				}

				else {	System.out.print(alineacionp[i][j] + " ");
				}
			}
			System.out.println();
		}	
	...
	public static void ingl(String inglaterra[], String supleingla []) { 
		...
		System.out.println("Equipo Predeterminado\n");
		int vectorPos = 0;
		for (int i = 0; i < alineacioni.length; i++) {
			for (int j = 0; j < alineacioni[i].length; j++) {
				if(vectorPos < inglaterra.length)
					alineacioni[3][0]=inglaterra[0]+" POR";
				alineacioni[5][3]=inglaterra[1]+" DFD";
				alineacioni[3][1]=inglaterra[2]+" DFC";
				alineacioni[1][3]=inglaterra[3]+" DFI";
				alineacioni[0][6]=inglaterra[4]+" CAI";
				alineacioni[2][6]=inglaterra[5]+" MD";
				alineacioni[4][6]=inglaterra[6]+" MI";
				alineacioni[6][6]=inglaterra[7]+" CAD";
				alineacioni[5][6]=inglaterra[8]+" ED";
				alineacioni[3][4]=inglaterra[9]+" DC";
				alineacioni[1][6]=inglaterra[10]+" EI";
			}
		}
		for (int i = 0; i < alineacioni.length; i++) {
			for (int j = 0; j < alineacioni[i].length; j++) {
				if(alineacioni[i][j]==null) {
					System.out.print("   ");
				}

				else {	System.out.print(alineacioni[i][j] + " ");
				}
			}
			System.out.println();
		}	
	...
	public static void IniciarJuego() {
		...
		do {
			...
			break;
			case(2):
				int jug2vsbrasil =Integer.parseInt(JOptionPane.showInputDialog("          SELECCIONA EL EQUIPO CONTRINCANTE:"
						+ "\n"
						+"\n 1. Francia"
						+ "\n 2. Alemania"
						+ "\n 3. Argentina"
			...
			break;
			case(3):
				int jug2vsalemania =Integer.parseInt(JOptionPane.showInputDialog("          SELECCIONA EL EQUIPO CONTRINCANTE:"
						+ "\n"
						+"\n 1. Francia"
						+ "\n 2. Brasil"
						+ "\n 3. Argentina"
			...
			break;
			case(4):
				int jug2vsargentina =Integer.parseInt(JOptionPane.showInputDialog("          SELECCIONA EL EQUIPO CONTRINCANTE:"
						+ "\n"
						+"\n 1. Francia"
						+ "\n 2. Brasil"
						+ "\n 3. Alemania"
			...
			break;
			case(5):
				int jug2vsportugal =Integer.parseInt(JOptionPane.showInputDialog("          SELECCIONA EL EQUIPO CONTRINCANTE:"
						+ "\n"
						+"\n 1. Francia"
						+ "\n 2. Brasil"
						+ "\n 3. Alemania"
			...
			break;
			case(6):
				int jug2vsinglaterra =Integer.parseInt(JOptionPane.showInputDialog("          SELECCIONA EL EQUIPO CONTRINCANTE:"
						+ "\n"
						+"\n 1. Francia"
						+ "\n 2. Brasil"
						+ "\n 3. Alemania"
